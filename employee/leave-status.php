...
<div class="container bg-white shadow">
    ...
    <?php 
            ...
            $(document).ready( function(){
                ...
                $('#linkBtn').attr('href', 'apply-leave.php').css('background-color', '#28a745').css('color', 'white');
                $('#linkBtn').text('Apply for Leave');
                $('#closeBtn').text('Remind me Later').css('background-color', '#f4c430').css('color', 'white');
            })
        </script>
        ";
        }
