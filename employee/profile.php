        ...
        <div class="col-12 col-lg-6 col-md-6" >
            <div class="card shadow" style="width: 22rem;">
                ...
                <h2 class="text-center mb-4"><?php echo $name; ?> </h2>
                    ...
                    <p class="card-text">Salary: MYR <?php echo $salary; ?> </p>
                    
                    <p class="text-center">
                    <a href="edit-profile.php" class="btn btn-outline-primary" style="color: #007bff; border-color: #007bff;">Edit Profile</a>
                    <a href="change-password.php" class="btn btn-outline-primary" style="color: #007bff; border-color: #007bff;">Change Password</a>
                    <a href="profile-photo.php" class="mt-2 btn btn-outline-primary" style="color: #007bff; border-color: #007bff;">Change profile photo</a>
                    </p>
                </div>
            </div>
        </div>
