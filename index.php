                    ...
                    <div class="form-input-content">
                        <div class="card login-form mt-5">
                            <div class="card-body shadow">   
                                    ...
                                    <h2 class="text-center pb-4">Smart Management System</h2>
                                ...
                                <div class="container mt-4">
                                  ...
                                  <div class="btn-toolbar justify-content-between">
                                        <div class="btn-group">
                                            <a href="employee/dashboard.php" class="btn btn-primary btn-lg" style="background-color: #ac0101;">Log-in As Employee </a>
                                        </div>

                                        <div class="btn-group">
                                        
                                            <a href="admin/dashboard.php" class="btn btn-primary btn-lg" style="background-color: #ac0101;">Log-In As Admin</a>
                                        </div>
