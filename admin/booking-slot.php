...
if (isset($_POST['finish_appointment_ajax'])) {
    $booking_id = filter_input(INPUT_POST, 'booking_id', FILTER_VALIDATE_INT); // Validate booking_id
            ...
            <script>
                document.addEventListener('DOMContentLoaded', function() {
                    ...
                    function updateStatus(bookingId, newStatus, button) {
                        ...
                        xhr.onreadystatechange = function() {
                            if (xhr.readyState === 4) {
                                if (xhr.status === 200 && xhr.responseText === 'Success') {
                                    ...
                                    // Optional: Reset the button after success
                        ...
                        xhr.send('id=' + encodeURIComponent(bookingId) + '&status=' + encodeURIComponent(newStatus));
                    }
