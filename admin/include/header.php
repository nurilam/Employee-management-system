...
<head>
    ...
    <link rel="icon" href="../include/img/logo.jpg">
           ...
           <br><br>       
            ...
            <li>
                <a href="./attendance-report.php" >
                    <i class="fa fa-bar-chart menu-icon"></i><span class="nav-text">Attendance Report</span>
                </a>
            </li>
            ...
            <li>
                <a href="./booking-slot.php" >
                    <i class="fa fa-calendar menu-icon"></i><span class="nav-text">Booking Slot</span>
                </a>
            </li>
